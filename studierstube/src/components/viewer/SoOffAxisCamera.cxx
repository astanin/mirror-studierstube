 ...
 * ======================================================================== */
/** SoOffAxisCamera.cxx contains the implementation of class SoOffAxisCamera
  *
  * @author Rainer Splechtna
  *
  * $Id: SoOffAxisCamera.cxx 3425 2004-07-14 12:09:17Z tamer $
  * @file                                                                   
  */
 /* ======================================================================== */
...
void SoOffAxisCamera::initClass()
{
	SO_NODE_INIT_CLASS(SoOffAxisCamera, SoCamera, "Camera");
}

// The constructor inits the fields of the node.

SoOffAxisCamera::SoOffAxisCamera() 
{
	SO_NODE_CONSTRUCTOR(SoOffAxisCamera);
...
void	SoOffAxisCamera::scaleHeight(float scaleFactor)
{
...
// Doc in superclass.
SbViewVolume SoOffAxisCamera::getViewVolume(float useaspectratio) const
{
    SbViewVolume vv;
...
int SoOffAxisCamera::projectToScreen(const SbVec3f &src, SbVec2f &dst) const
{    
    SbVec3f res;
...
void SoOffAxisCamera::GLRender(SoGLRenderAction* action)
{
...
void 
SoOffAxisCamera::doAction(SoAction* action)
{
	// read values of this camera
	SbVec3f epos = eyepointPosition.getValue();
...
void
SoOffAxisCamera::getBoundingBox(SoGetBoundingBoxAction *action)
{
...
void
SoOffAxisCamera::rayPick(SoRayPickAction *action)
{
    // NIL
}
