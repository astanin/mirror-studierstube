...
#  ifdef _ARTKP_IS_WINDOWS_
	...
	fprintf(fp, "          GETLINE:                         %.3f msecs  (%.2f %%)\n", 1000.0f*getTime(GETLINE)/nNumRuns, 100.0f*getTime(GETLINE)/overall);
	fprintf(fp, "              MATRIXPCA:                   %.3f msecs  (%.2f %%)\n", 1000.0f*getTime(MATRIXPCA)/nNumRuns, 100.0f*getTime(MATRIXPCA)/overall);
	fprintf(fp, "          GETCODE:                         %.3f msecs  (%.2f %%)\n", 1000.0f*getTime(GETCODE)/nNumRuns, 100.0f*getTime(GETCODE)/overall);
