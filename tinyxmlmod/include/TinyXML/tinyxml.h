...
// TinyXMLMOD_begin
//
// This is TinyXMLMod, a modified version of TinyXML
// (currently based on TinyXML 2.4.2)
//
// Tt compiles into a static LIB or DLL, includes TinyXPath and
// some more changes to make it suitable for MuddleWare and SAM
// (unique ID per node, a custom memory manager, etc.)


// Check for TINYXML_MOD to distinguish between
// original TinyXML and TinyXML_Mod
//
#ifndef TINYXML_MOD
#define TINYXML_MOD
#endif
...
#  define TINYXML_MOD_API
#  ifdef TINYXML_MOD_DLL
#    pragma message("ERROR: you can not define both TINYXML_MOD_STATIC and TINYXML_MOD_DLL")
#  endif
#else
//#  ifdef TINYXML_MOD_DLL
//#    ifdef TINYXML_MOD_STATIC
//#      pragma message("ERROR: you can not define both TINYXML_MOD_STATIC and TINYXML_MOD_DLL")
//#    endif
#    ifdef TINYXML_MOD_EXPORTS
#      define TINYXML_MOD_API __declspec(dllexport)
#    else
#      define TINYXML_MOD_API __declspec(dllimport)
#    endif
//#  else
//#    pragma message("ERROR: TinyXML must be compiled either with TINYXML_MOD_STATIC or with TINYXML_MOD_DLL")
//#    pragma error
//#  endif
#endif
// TinyXMLMOD_end
...
// TinyXMLMOD_begin
typedef unsigned int TiXmlId;

class TINYXML_MOD_API TiXmlAutoId {
public:
	TiXmlAutoId() : id(++idCounter)  {}
	TiXmlId get() const {  return id;  }

private:
	TiXmlId id;
	static TiXmlId idCounter;
};
// TinyXMLMOD_end
...
/*	Internal structure for tracking location of items
	in the XML file.
*/
struct TINYXML_MOD_API TiXmlCursor			// TinyXMLMOD
{
	TiXmlCursor()		{ Clear(); }
...
/** TiXmlBase is a base class for every class in TinyXml.
	...
	@endverbatim
*/
class TINYXML_MOD_API TiXmlBase				// TinyXMLMOD
{
...
*/
class TINYXML_MOD_API TiXmlNode : public TiXmlBase			// TinyXMLMOD
{
	friend class TiXmlDocument;
	friend class TiXmlElement;
...
*/
class TINYXML_MOD_API TiXmlAttribute : public TiXmlBase			// TinyXMLMOD_begin
{
...
public:
	...
	*/
	...
	void SetElement( TiXmlElement* el )	{ element = el; }		// TinyXMLMOD

	TiXmlElement* GetElement()	{  return element; }			// TinyXMLMOD

private:
	TiXmlAttribute( const TiXmlAttribute& )  {  assert(false);  }				// not implemented.
	void operator=( const TiXmlAttribute& base )  {  assert(false);  }			// not allowed.
	...
	TiXmlAttribute*	prev;
	TiXmlAttribute*	next;
	TiXmlElement* element;		// TinyXMLMOD: required for getting element from attribute
};
...
*/
class TINYXML_MOD_API TiXmlAttributeSet			// TinyXMLMOD
{
public:
	TiXmlAttributeSet();
	~TiXmlAttributeSet();
...
*/
class TINYXML_MOD_API TiXmlElement : public TiXmlNode				// TinyXMLMOD
{
public:
	...
	*/
	...
	TiXmlId getUniqueID() const  {  return uniqueID.get();  }				// TinyXMLMOD
...
public:																		// TinyXMLMOD
	virtual void StreamOut( TIXML_OSTREAM * out ) const;					// TinyXMLMOD
protected:																	// TinyXMLMOD
...
private:
	TiXmlAutoId			uniqueID;											// TinyXMLMOD
...
/**	An XML comment.
*/
class TINYXML_MOD_API TiXmlComment : public TiXmlNode						// TinyXMLMOD
{
public:
...
*/
class TINYXML_MOD_API TiXmlText : public TiXmlNode							// TinyXMLMOD
{
	friend class TiXmlElement;
public:
...
*/
class TINYXML_MOD_API TiXmlDeclaration : public TiXmlNode							// TinyXMLMOD
{
public:
...
*/
class TINYXML_MOD_API TiXmlUnknown : public TiXmlNode							// TinyXMLMOD
{
public:
...
*/
class TINYXML_MOD_API TiXmlDocument : public TiXmlNode							// TinyXMLMOD
{
public:
...
/**
	...
	@endverbatim
*/
class TINYXML_MOD_API TiXmlHandle											// TinyXMLMOD
{
public:
